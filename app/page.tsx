...
export default function HomePage() {
  ...
  const loadConversations = useCallback(async () => {
    ...
    try {
      ...
      setSelectedConversationId((current) => current ?? list[0]?.conversation_id ?? null);
    } catch (error) {
  ...
  return (
    <main className="h-screen overflow-hidden bg-black text-white">
      <div className="mx-auto flex h-screen max-w-[1700px] flex-col px-6 py-8">
        <div className="mb-8">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1 className="text-5xl font-semibold tracking-tight">Nancy Monitor</h1>
        ...
        <div className="grid min-h-0 flex-1 grid-cols-1 gap-6 lg:grid-cols-[360px_minmax(0,1fr)_320px]">
                ...
                <div className="space-y-5">
                  {messages.map((msg) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`max-w-[84%] ${isOutbound ? "items-end" : "items-start"}`}>
                          <div
